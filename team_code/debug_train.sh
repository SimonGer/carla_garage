...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=0 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id tfpp_plantwps2_010_0 --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 31 --batch_size 4 --lr 3e-4 --setting all \
    ...
    --use_controller_input_prediction 1 --continue_epoch 0 --load_file /home/geiger/gwb301/code/carla_garage_fresh/results/tfpp_plantwps_010_0/model_0030.pth --cpu_cores 8 --num_repetitions 1 --use_cosine_schedule 1 --cosine_t0 1 \
