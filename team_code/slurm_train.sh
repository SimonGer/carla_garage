#!/bin/bash
#SBATCH --job-name=tf_plantwps3_010_0
#SBATCH --ntasks=1
#SBATCH --nodes=1
#SBATCH --time=3-00:00
#SBATCH --gres=gpu:4
#SBATCH --cpus-per-task=32
#SBATCH --output=/home/geiger/gwb301/code/carla_garage_neu/results/logs/tfpp_plantwps3_010_0_%a_%A.out  # File to which STDOUT will be written
#SBATCH --error=/home/geiger/gwb301/code/carla_garage_neu/results/logs/tfpp_plantwps3_010_0_%a_%A.err   # File to which STDERR will be written
...
torchrun --nnodes=1 --nproc_per_node=4 --max_restarts=0 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id tfpp_plantwpsneu_010_0 --use_disk_cache 1 --crop_image 1 --seed 0 --epochs 31 --batch_size 16 --lr 3e-4 --setting all \
